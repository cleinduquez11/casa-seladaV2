...
io.sockets.on("connection", socket => {
    ...
    socket.on('nav2', function (args) {
      ...
      socket.on('reset1', function (args) {
        con.query(`UPDATE schedule SET time_on ="", time_off = "",monday = "", tuesday = "",wednesday = "",thursday = "",friday = "",saturday = "",sunday = "", displaytext="" , status = "0" WHERE schedule.id = 2;`, function (err, result, fields) {
        });
        //console.log(args);
      });
    ...
    socket.on('nav5', function (args) {
      ...
      socket.on('reset4', function (args) {
        con.query(`UPDATE schedule SET time_on ="", time_off = "",monday = "", tuesday = "",wednesday = "",thursday = "",friday = "",saturday = "",sunday = "", everyday="",displaytext="", status = "0" WHERE schedule.id = 5;`, function (err, result, fields) {
        });
        //console.log(args);
      });
      
      socket.on('defaultAerator', function (args) {
        con.query(`UPDATE schedule SET time_on ="", time_off = "",monday = "1", tuesday = "1",wednesday = "1",thursday = "1",friday = "1",saturday = "1",sunday = "1", everyday="", displaytext="ON/OFF Interval was set Every 30 mins", status = "1" WHERE schedule.id = 5;`, function (err, result, fields) {
        });
        //console.log(args);
      });
      con.query(`SELECT * FROM schedule WHERE schedule.id=?;`, [args], function (err, result, fields) {
